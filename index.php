...
<head>
	...
	<title>Masjid Kampus UNDIP</title>
	<link rel="icon" href="https://th.bing.com/th/id/OIP.PVLOL5I8in12Yxu5sIl5SgHaHa?pid=ImgDet&rs=1">
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="http://localhost/kasmasjid/" class="nav-link">Home</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="http://localhost/kasmasjid/" class="brand-link">
				<img src="https://th.bing.com/th/id/OIP.PVLOL5I8in12Yxu5sIl5SgHaHa?pid=ImgDet&rs=1" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> Masjid UNDIP</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="http://localhost/kasmasjid/?page=MyApp/edit_pengguna&kode=3" class="d-block">
							<?php echo $data_nama; ?>
						</a>
        ...
        ?>
						<li class="nav-item">
							<a href="http://localhost/kasmasjid/" class="nav-link">
    ...
    ?>
		...
		<footer class="main-footer">
			...
			Copyright &copy;
			<a target="_blank" href="https://www.instagram.com/arjunakhamonangan/">
				<strong> Kelompok 9</strong>
			</a>
			All rights reserved.
		</footer>
